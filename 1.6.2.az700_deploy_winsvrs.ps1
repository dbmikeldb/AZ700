...
$AzWinSvr001 = Get-AzVM -Name $AzWinSvr001Name -ResourceGroupName $AzWinSvrRgName -ErrorAction SilentlyContinue
...
$AzWinSvr002 = Get-AzVM -Name $AzWinSvr002Name -ResourceGroupName $AzWinSvrRgName -ErrorAction SilentlyContinue
...
$AzWinSvr003 = Get-AzVM -Name $AzWinSvr003Name -ResourceGroupName $AzWinSvrRgName -ErrorAction SilentlyContinue
